...
bash "$repo/tests/test_sam_platform.sh"
bash "$repo/tests/test_used_run_provenance.sh"
...
python3 -m pytest -q "$repo/tests/test_round2_liftback_streaming_contract.py"
